...
export default function Settings() {
  ...
  const handleAccountSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put("http://localhost:3001/api/managers/updatemanager", formDataToSend, {
        headers: {
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    try{
      ...
      await axios.put("http://localhost:3001/api/managers/updatepassword", formDataToSend, {
        headers: {
