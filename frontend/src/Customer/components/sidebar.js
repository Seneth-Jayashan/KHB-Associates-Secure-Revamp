...
export default function Sidebar() {
  ...
  return (
    <div className="min-h-screen w-64 bg-white text-blue-950 flex flex-col">
      ...
      <div className="px-3 py-1 text-xl font-bold text-center uppercase">
      ...
      <nav className="flex-1">
        <ul>
          ...
          <li className="py-2 px-4 text-md">
            <button
              onClick={() =>
                handleNavigation("/customer-dashboard/settings")
              }
              className="block w-full text-left py-2 px-4 rounded-md hover:bg-gray-100 transition-all"
            >
              <span className="mr-2">
      ...
      <div className="py-2 px-4 my-2">
        <button
          className="bg-[#ff4c51] text-white w-full py-3 rounded-xl hover:bg-[#ff0000] flex items-center justify-center transition-all duration-300"
